...
namespace SmartTalent.Hotel.Base
{
    public class BaseController<T, TImplementacion> : ControllerBase where T : class, new() where TImplementacion : IRepository<T>
    {
        /// <summary>
        /// Repositorio de Negocio de la Entidad <TImplementacion></TImplementacion>
        /// </summary>
        ...
        /// <summary>
        /// Constructor para inicializar la base con el BusinessRules de la entidad
        /// </summary>
